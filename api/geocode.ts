 ...
 *
 * Note: Prefer GOOGLE_MAPS_API_KEY to avoid implying the key is safe to ship to clients,
 * but this route supports both names for compatibility with existing setups.
 */
