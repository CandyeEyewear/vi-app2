/**
 * API Route: Generate Open Graph metadata for causes
 * Handles /api/og/cause/[slug]
 */
...
export default async function handler(req: any, res: any) {
  ...
  if (!slug) {
    return res.status(400).send('Cause slug is required');
  }

  try {
    // Fetch cause data from Supabase
...
<body>
  <div class="container">
    ...
    <a href="vibe://causes/${params.url.split('/').pop()}" class="button">Open in VIbe App</a>
