/**
 * Share Opportunity Modal Component
 * Allows users to add an optional comment and choose visibility when sharing an opportunity to their feed
 */
...
export default function ShareOpportunityModal({
  visible,
  onClose,
  onShare,
  opportunity,
      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <View style={styles.header}>
            <Text style={styles.title}>Share Opportunity</Text>
          ...
          <ScrollView style={styles.scrollContent}>
            ...
            <View style={styles.commentSection}>
              ...
              <TextInput
                ...
                placeholder="Say something about this opportunity..."
