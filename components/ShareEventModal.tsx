 ...
 * Allows users to add an optional comment and choose visibility when sharing an event to their feed
 */
...
import { formatEventDate, formatEventTime } from '../services/eventsService';
