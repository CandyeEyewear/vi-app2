/**
 * Supervisor Event Actions Screen
 * Intermediary screen: Event -> (Manage/Create) - No delete access
 */
...
export default function SupervisorEventActionsScreen() {
        ...
        >
          ...
          <View style={styles.actionContent}>
            ...
            <Text style={[styles.actionSubtitle, { color: colors.textSecondary }]}>
              View and edit community events
            </Text>
          </View>
        </AnimatedPressable>
