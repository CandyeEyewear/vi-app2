/**
 * Admin Opportunity Actions Screen
 * Intermediary screen: Opportunity -> (Manage/Create)
 */
...
import { ChevronLeft, Calendar, FileText, Plus, ShieldCheck } from 'lucide-react-native';
import { Colors } from '../constants/colors';
import { AnimatedPressable } from '../components/AnimatedPressable';

export default function AdminOpportunityActionsScreen() {
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.actionContent}>
            <Text style={[styles.actionTitle, { color: colors.text }]}>Manage Opportunities</Text>
            <Text style={[styles.actionSubtitle, { color: colors.textSecondary }]}>
              Edit, delete, or show admin QR codes
            </Text>
          </View>
        </AnimatedPressable>
        ...
        >
          ...
          <View style={styles.actionContent}>
            <Text style={[styles.actionTitle, { color: colors.text }]}>Create Opportunity</Text>
            <Text style={[styles.actionSubtitle, { color: colors.textSecondary }]}>
        ...
        >
          ...
          <View style={styles.actionContent}>
            <Text style={[styles.actionTitle, { color: colors.text }]}>Opportunity Reviews</Text>
            <Text style={[styles.actionSubtitle, { color: colors.textSecondary }]}>
