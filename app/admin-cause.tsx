/**
 * Admin Cause Actions Screen
 * Intermediary screen: Cause -> (Manage/Create)
 */
...
import { ChevronLeft, FileText, Heart, Plus } from 'lucide-react-native';
import { Colors } from '../constants/colors';
import { AnimatedPressable } from '../components/AnimatedPressable';

export default function AdminCauseActionsScreen() {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { paddingTop: insets.top + 16, borderBottomColor: colors.border }]}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={[styles.headerTitle, { color: colors.text }]}>Causes</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.actionContent}>
            <Text style={[styles.actionTitle, { color: colors.text }]}>Manage Causes</Text>
        ...
        >
          <View style={[styles.actionIconContainer, { backgroundColor: '#E91E63' + '15' }]}>
            <Plus size={24} color="#E91E63" />
          </View>
          <View style={styles.actionContent}>
            <Text style={[styles.actionTitle, { color: colors.text }]}>Create Cause</Text>
            <Text style={[styles.actionSubtitle, { color: colors.textSecondary }]}>
