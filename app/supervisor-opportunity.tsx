/**
 * Supervisor Opportunity Actions Screen
 * Intermediary screen: Opportunity -> (Manage/Create) - No delete access
 */
...
import { ChevronLeft, Calendar, FileText, Plus } from 'lucide-react-native';
import { Colors } from '../constants/colors';
import { AnimatedPressable } from '../components/AnimatedPressable';

export default function SupervisorOpportunityActionsScreen() {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <AnimatedPressable
          ...
          onPress={() => router.push('/(supervisor)/opportunities')}
        >
