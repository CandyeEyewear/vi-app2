-- ============================================
-- ADD OPPORTUNITY NOTIFICATION FUNCTION
-- ============================================
-- This migration adds the missing create_opportunity_notifications function
-- which was absent from the original create_notification_functions.sql migration.
-- Without this function, the RPC call in create-opportunity.tsx fails silently,
-- causing push and email notifications to be skipped for new opportunities.
-- ============================================
